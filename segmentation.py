...
def train(model, device, train_loader, criterion, optimizer):
    ...
    """
    ##### rough work 
    #print("the value of train_loader is ", train_loader)
    ...
    for i, batch in enumerate(train_loader):
        ...
        #argets = targets.to(torch.LongTensor)
        
        #forward pass
        #targets = targets.to(torch.LongTensor)
...
def val(model, device, val_loader, criterion):
    ...
    val_iou = total_miou/num_samples
    #print(val_iou)
...
def main():
    ...
    ##############rough work to check if rgb images are being read ----- verified, images are being read :)
    #print("train_dataset", train_dataset)
    #print("train_dir", train_dir)
    #idx = 1
    #print(os.path.join(train_dir, 'rgb', f'{idx}_rgb.png'))
    #import image
    #rgb_image = image.read_rgb(os.path.join(os.path.join(train_dir, 'rgb', f'{idx}_rgb.png')))
    #print(rgb_image)
